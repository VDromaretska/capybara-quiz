import "./App.css";
import createCapyTree from "../exampleTrees/capybaraTree";
import { useEffect, useState } from "react";

export default function App() {
    const [currentTree, setCurrentTree] = useState(createCapyTree());
    const [question, setQuestion] = useState("");
    console.log(currentTree, question);
    useEffect(() => {
        setQuestion(currentTree.question);
    }, [currentTree]);
    ...
    return (
        <div>
            ...
            <div className="footer">
                <p>
                    Images provided by{" "}
                    <a href="https://github.com/looskie/capybara-api">
                        capybara-api.
                    </a>
                </p>
            </div>
